...
creg c[13];
creg meas[13];
rz(1.7498779296875*pi) q[0];
rz(3.749755859375*pi) q[1];
rz(1.74951171875*pi) q[2];
rz(0.7490234375*pi) q[3];
rz(0.248046875*pi) q[4];
rz(0.24609375*pi) q[5];
rz(0.2421875*pi) q[6];
rz(0.234375*pi) q[7];
rz(2.21875*pi) q[8];
rz(0.1875*pi) q[9];
rz(1.625*pi) q[10];
rz(3.5*pi) q[11];
rx(0.49975585937500067*pi) q[12];
rx(1.5*pi) q[0];
rx(1.5*pi) q[1];
rx(1.5*pi) q[2];
rx(1.5*pi) q[3];
