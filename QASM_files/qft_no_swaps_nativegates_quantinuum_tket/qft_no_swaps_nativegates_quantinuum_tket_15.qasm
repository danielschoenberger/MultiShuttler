...
creg c[15];
creg meas[15];
rz(1.749969482421875*pi) q[0];
rz(1.74993896484375*pi) q[1];
rz(0.7498779296875*pi) q[2];
rz(0.749755859375*pi) q[3];
rz(3.74951171875*pi) q[4];
rz(3.7490234375*pi) q[5];
rz(0.248046875*pi) q[6];
rz(0.24609375*pi) q[7];
rz(0.2421875*pi) q[8];
rz(0.234375*pi) q[9];
rz(2.21875*pi) q[10];
rz(0.1875*pi) q[11];
